...
public class Combat_Script : MonoBehaviour
{
    ...
    private void MeleeAttack(GameObject target)
    {
        ...
        animator.SetTrigger("Idle");
        animator.ResetTrigger("Attack");
        target.GetComponent<Combat_Script>().animator.SetTrigger("Hit");
        target.GetComponent<Combat_Script>().animator.ResetTrigger("Attack");
        target.GetComponent<Combat_Script>().animator.ResetTrigger("Idle");
    }
